    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex-1 flex items-center gap-2">
        ...
        <input
          ...
          style={{
            background: `linear-gradient(to right, var(--color-background-ui) 0%, var(--color-background-ui) ${progressPercent}%, color-mix(in srgb, var(--color-mid-gray) 30%, transparent) ${progressPercent}%, color-mix(in srgb, var(--color-mid-gray) 30%, transparent) 100%)`,
          }}
        />
