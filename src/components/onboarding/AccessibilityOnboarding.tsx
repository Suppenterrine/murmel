              ...
              <div className="flex-1 min-w-0">
                ...
                {permissions.microphone === "granted" ? (
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-lg bg-logo-primary hover:bg-logo-primary/90 text-on-logo-primary text-sm font-medium transition-colors"
                  >
                    {isWindows
