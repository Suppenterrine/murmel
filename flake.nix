{
  description = "Murmel - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          murmel = pkgs.rustPlatform.buildRustPackage {
            pname = "murmel";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/Suppenterrine/murmel";
          ...
          default = self.packages.${system}.murmel;
        }
      );
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.murmel.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.murmel;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.murmel.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.murmel;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Murmel development environment"
              bun install
