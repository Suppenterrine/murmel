; Custom NSIS template for Murmel with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Murmel for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Murmel releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Murmel Portable Mode"
    FileClose $0
