...
define_class!(
    ...
    #[name = "MurmelPasteProvider"]
    #[ivars = ProviderIvars]
    pub struct MurmelPasteProvider;

    impl MurmelPasteProvider {
...
struct MacPending {
    ...
    provider: Option<Retained<MurmelPasteProvider>>,
    auto_submit: bool,
...
pub(super) fn run(
    ...
    let provider = MurmelPasteProvider::new(state.clone(), text.to_string());
