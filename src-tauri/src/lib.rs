...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::history::retry_history_entry_refinement,
    ...
    // Single-instance forwards CLI args to an already-running Murmel and exits.
